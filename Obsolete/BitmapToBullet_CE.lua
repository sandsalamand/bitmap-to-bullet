...
local spawnTable = {[0]= 13530000,[1]= 13530000,[2]= 13530000,[3]= 13530000,[4]= 13530000,[5]= 13530000,[6]= 13530000,[7]= 13530000,[8]= 0,[9]= 13530000,[10]= 13530000,[11]= 13530000,[12]= 13530000,[13]= 13530000,[14]= 13530000,[15]= 0}
  ...
  for yIndex = 0, (bmpHeight - 1), 1 do
    for xIndex = 0, (bmpWidth - 1), 1 do
      ...
      if overloadTable ~= nil then
      	if spawnTable[pixelArray[yIndex][xIndex]] == 0 then bulletToLaunch = nil
        else bulletToLaunch = overloadTable
        end
      else bulletToLaunch = spawnTable[pixelArray[yIndex][xIndex]] -- might need to swap x and y, idk how lua nested table accessing works
      end
